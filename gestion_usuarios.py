...
def obtener_face_encoding():
    ...
    while True:
        ...
        reference_encodings = face.face_encodings(
            reference_rgb, reference_locations, model='small')
        ...
        if len(face_encodings) > 0:
            ...
            for face_encoding in face_encodings:
                ...
                for i, encoding_jugador in enumerate(encodings_jugadores):
                    resultados_comparacion = face.compare_faces(
                        encoding_jugador, face_encoding)
